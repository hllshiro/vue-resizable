<template>
  <div class="main-demo">
    <h1>Vue Resizable 比例属性与显隐控制测试</h1>
    <p>测试基于ratio属性的面板比例控制和显隐功能</p>
    ...
    <div class="test-section">
      ...
      >
        ...
        <ResizablePanel
          :ratio="2"
          style="min-width: 500px; background: #f8f9fa"
        >
          <ResizableContainer direction="vertical" style="height: 100%">
            <!-- 显隐控制面板 -->
            <ResizablePanel style="min-height: 100px" :ratio="0.5">
            ...
            <ResizablePanel style="min-height: 200px">
              <div class="test-content">
                <h3>测试1: 基于 ratio 属性的面板比例控制</h3>
                <p class="description">
                  使用上方的复选框控制面板显隐，观察分割器智能显隐和基于ratio的空间重分配
                </p>
                <ResizableContainer
                  direction="horizontal"
        ...
        <!-- 右侧：事件日志 -->
        <ResizablePanel :ratio="1.2" style="min-width: 300px; background: #fff">
          <div class="event-log">
            <h3>事件日志</h3>
    ...
    <div class="test-section">
      ...
      >
        <ResizablePanel
          ...
          :ratio="1"
          style="min-height: 50px; background: #ffcdd2"
        >
          <div class="panel-content">
            <h4>顶部面板 (ratio=1)</h4>
          </div>
        ...
        <ResizablePanel
          ...
          :ratio="1"
          style="min-height: 40px; background: #bbdefb"
        >
          <div class="panel-content">
            <h4>底部面板 (ratio=1)</h4>
          </div>
    ...
    <div class="test-section">
      ...
      >
        <ResizablePanel
          ...
          :ratio="1"
          style="min-width: 150px; background: #ffcdd2"
        >
          <div class="panel-content">
            <h4>左侧面板 (ratio=1)</h4>
          </div>
        ...
        <ResizablePanel
          :ratio="2"
          style="min-width: 200px; background: #f5f5f5"
        >
          <ResizableContainer direction="vertical" style="height: 100%">
            <ResizablePanel
        ...
        <ResizablePanel
          ...
          :ratio="0.8"
          style="min-width: 100px; background: #fff3e0"
        >
          <div class="panel-content">
            <h4>右侧面板 (ratio=0.8)</h4>
          </div>
        </ResizablePanel>
      </ResizableContainer>
    </div>
    ...
    <div class="instructions">
      ...
      <ul>
        ...
        <li>
          <strong>ratio比例分配:</strong>
          使用ratio属性控制面板的初始大小比例，取代固定尺寸设置
        </li>
